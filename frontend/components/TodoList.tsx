            ...
            <div className="max-w-2xl mx-auto p-4 space-y-8">
                <div className="space-y-4">
                    ...
                    <p className="text-gray-600 text-center">
                        Please log in to view your todos: <Link href={"/signup"}>Login/Signup</Link>
                    </p>
                </div>
            </div>
        );
            ...
            <div className="space-y-4">
                ...
                <div className="flex space-x-2">
                    ...
                    <button
                        ...
                        focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center space-x-2"
                    >
